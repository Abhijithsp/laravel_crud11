...
<nav class="border-gray-200 bg-white dark:bg-gray-900">
    <div class="mx-auto flex max-w-screen-xl flex-wrap items-center justify-between p-4">
        <a href="/dashboard" class="flex items-center space-x-3 rtl:space-x-reverse">
            ...
            <span class="self-center whitespace-nowrap text-2xl font-semibold dark:text-white">CRUD 11</span>
        </a>
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-default">
            <ul class="mt-4 flex flex-col rounded-lg border border-gray-100 bg-gray-50 p-4 font-medium rtl:space-x-reverse dark:border-gray-700 dark:bg-gray-800 md:space-x-8 md:mt-0 md:flex-row md:border-0 md:bg-white md:p-0 md:dark:bg-gray-900">
                @guest
                ...
                @auth
                    ...
                    <span class="text-red-700 dark:text-red-500">{{Auth::user()->name}}</span>
